  ...
  const sections = [
    {
      ...
      icon: CheckCircle,
      content: [
  "By accessing and using InvestEd: India's Multilingual Stock Market Learning Platform, you accept and agree to be bound by these Terms and Conditions",
    ...
    },
    {
      ...
      icon: FileText,
      content: [
  "InvestEd: India's Multilingual Stock Market Learning Platform provides educational content and tools for learning about financial markets and investing",
    ...
    },
    {
      ...
      icon: Shield,
      content: [
  "All content on the platform, including text, graphics, logos, and software, is owned by InvestEd: India's Multilingual Stock Market Learning Platform",
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8">
              Please read these terms carefully before using our platform. They govern your use of InvestEd: India's Multilingual Stock Market Learning Platform services.
            </p>
